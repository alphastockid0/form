            ...
            columns: {
                identifier: function() {
                    ...
                    $td.each(function() {
                        ...
                        var input = '<input class="tabledit-input tabledit-identifier" type="hidden" name="' + settings.columns.identifier[1] + '" value="' + trid + '" disabled>';
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        var toolbar = '<div class="tabledit-toolbar ' + settings.toolbarClass + '" style="text-align: center;">\n\
                        ...
                        $table.find('tr:gt(0):not(.ojoedit)').append('<td style="white-space: nowrap; width: 1%;">' + toolbar + '</td>');
                    }
                }
            }
        };
